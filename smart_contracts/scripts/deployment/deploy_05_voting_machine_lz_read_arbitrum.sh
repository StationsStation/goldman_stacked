...
votingTokenAddress=$(jq -r '.votingTokenAddress' scripts/deployment/globals_arbitrum_mainnet.json)
...
echo "$(jq '. += {"votingMachineLzReadAddress":"'$votingMachineLzReadAddress'"}' scripts/deployment/globals_arbitrum_mainnet.json)" > scripts/deployment/globals_arbitrum_mainnet.json
