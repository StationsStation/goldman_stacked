...
votingTokenAddress=$(jq -r '.votingTokenAddress' scripts/deployment/globals_hedera_mainnet.json)
...
echo "$(jq '. += {"votingMachineLzReadAddress":"'$votingMachineLzReadAddress'"}' scripts/deployment/globals_hedera_mainnet.json)" > scripts/deployment/globals_hedera_mainnet.json
